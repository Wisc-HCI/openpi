# Spatial legibility evaluation: pi05_droid

## Evaluation protocol

- Checkpoint: `/home/hci-lab/.cache/openpi/openpi-assets/checkpoints/pi05_droid`.
...
Fine-tuning trajectories: pre-grasp final accuracy **0.562**,
mean Early-AUC **0.500**.

Held-out trajectories: pre-grasp final accuracy **0.875**,
full-trajectory final accuracy **0.750**, and mean
Early-AUC **0.503**.
The geometric observer reaches pre-grasp final accuracy
**1.000** and mean Early-AUC
**0.839** on those same trajectories.

Mean true-instruction residual energy is **1.0x** higher on the
...
**0.595**. Correlation between geometric-baseline Early-AUC
and VLA Early-AUC is **-0.286**.
...
|---|---|---|---|---|---|---|---|---|
| C0_natural_direct | 0.499 | 0.498 | 0.500 | 0.272 | 0.754 | 1.000 | 1.106 | 0.004 |
| C1_mild_exaggeration | 0.502 | 0.503 | 1.000 | 0.290 | 0.909 | 1.000 | 1.202 | 0.003 |
| C2_strong_exaggeration | 0.505 | 0.508 | 1.000 | 0.285 | 0.826 | 1.000 | 1.449 | 0.004 |
| C3_extreme_exaggeration | 0.506 | 0.508 | 1.000 | 0.304 | 0.866 | 1.000 | 2.239 | 0.001 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| C0_natural_direct | left | 0.500 | 0.500 | 0.499 | 0.277 | 31.250 | 0.000 | 0.000 | 0.022 | 0.889 |
| C0_natural_direct | right | 0.497 | 0.496 | 0.497 | 0.267 | 25.000 | 0.008 | 0.000 | 0.011 | 0.944 |
| C1_mild_exaggeration | left | 0.503 | 0.503 | 0.503 | 0.302 | 62.500 | 0.007 | 0.000 | 0.031 | 0.905 |
| C1_mild_exaggeration | right | 0.502 | 0.503 | 0.504 | 0.279 | 31.250 | 0.000 | 0.000 | 0.012 | 0.810 |
| C2_strong_exaggeration | left | 0.510 | 0.514 | 0.513 | 0.301 | 59.375 | 0.009 | 0.000 | 0.019 | 1.000 |
| C2_strong_exaggeration | right | 0.500 | 0.501 | 0.500 | 0.269 | 28.125 | 0.000 | 0.000 | 0.009 | 0.917 |
| C3_extreme_exaggeration | right | 0.504 | 0.507 | 0.506 | 0.317 | 68.750 | 0.001 | 0.000 | 0.031 | 0.833 |
| C3_extreme_exaggeration | left | 0.507 | 0.509 | 0.510 | 0.291 | 46.875 | 0.000 | 0.000 | 0.005 | 0.963 |
